//-----------------------------------------------------------------------
// <copyright file="Response.cs" company="KriaSoft, Ltd.">
...
namespace TDAmeritrade.Models
{
    ...
    /// <summary>
    /// Represents a response object returned by the <see cref="TDAClient"/> instance.
    /// </summary>
    /// <typeparam name="T">The type of the value object.</typeparam>
    public class Response<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Response`1"/> class.
        /// </summary>
